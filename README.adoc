...
If the default layout and the `page-layout` attribute are both unset, the AsciiDoc processor will generated a standalone document (`header_footer: true`).
...
* `:page-layout:` or `:page-layout: _auto_layout` -- use the auto-detected layout
